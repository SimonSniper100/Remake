...
public class TransformEntity extends UnitWaterMove{
    ...
    public void draw(){
        ...
        ExtenalTransformDraw();
        Draw.reset();
        if(TransformNow)ExtenalTransformDrawWhenTranform();
        Draw.reset();
    }
    /**Use for override when create*/
    public void ExtenalTransformDraw(){

    }
    public void ExtenalTransformDrawWhenTranform(){

    }
    public void ConfigTransform(){}
    /**Fade In And Out */
